...
AutoCut Studio 1.1 ships one CEP execution path. `js/main.js` contains the
...
executable. Dolly keyframe computation is the only browser-side domain module;
marker ownership, timing conversion, motion ownership, and color-effect control
remain in the Premiere host implementation.
